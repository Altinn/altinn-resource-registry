...
namespace Altinn.ResourceRegistry.Core.Helpers
{
    ...
    public static partial class ServiceResourceHelper
    {
        ...
        /// </summary>
        public static bool ValidateResource(ServiceResource serviceResource, bool isUpdate, out Dictionary<string, List<string>> validationMessages)
        {
            bool isValid = true;
            ...
            if (!isUpdate && !ResourceIdentifierRegex().IsMatch(serviceResource.Identifier))
            {
