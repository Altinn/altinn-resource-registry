        ...
        : WebApplicationTests(dbFixture, webApplicationFixture)
{
        ...
        : AccessListControllerTests(dbFixture, webApplicationFixture)
    {
            ...
            : EtagHeadersTests(dbFixture, webApplicationFixture)
        {
            ...
            protected override HttpRequestMessage CreateRequest(AccessListInfo info)
                => new(HttpMethod.Get, $"/resourceregistry/api/v1/access-lists/{info.RegistryOwner}/{info.Identifier}");
        ...
        : AccessListControllerTests(dbFixture, webApplicationFixture)
    {
            ...
            : EtagHeadersTests(dbFixture, webApplicationFixture)
        {
            ...
            protected override HttpRequestMessage CreateRequest(AccessListInfo info)
                => new(HttpMethod.Delete, $"/resourceregistry/api/v1/access-lists/{info.RegistryOwner}/{info.Identifier}");
        ...
        : AccessListControllerTests(dbFixture, webApplicationFixture)
    {
            ...
            : EtagHeadersTests(dbFixture, webApplicationFixture)
        {
            ...
            protected override HttpRequestMessage CreateRequest(AccessListInfo info)
            {
                ...
                return new(HttpMethod.Put, $"/resourceregistry/api/v1/access-lists/{info.RegistryOwner}/{info.Identifier}")
                {
        ...
        : AccessListControllerTests(dbFixture, webApplicationFixture)
    {
        ...
        {
            var response = await client.GetAsync($"/resourceregistry/api/v1/access-lists/{info.RegistryOwner}/{info.Identifier}");
        ...
        {
            var aggregate = await Repository.LoadAccessList(info.RegistryOwner, info.Identifier);
        ...
        public async Task Returns_Mismatch_When_ETag_Is_Up_To_Date()
        {
            ...
            else
            {
                ...
                var latest = await Repository.LookupInfo(info.RegistryOwner, info.Identifier);
