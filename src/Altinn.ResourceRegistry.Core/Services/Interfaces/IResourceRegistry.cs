...
namespace Altinn.ResourceRegistry.Core.Services.Interfaces
{
    ...
    public interface IResourceRegistry
    {
        ...
        /// <param name="includeMigratedResources">Whether or not to include migrated resources from A1/A2</param>
        /// <param name="cancellationToken">The <see cref="CancellationToken"/></param>
        /// <returns></returns>
        Task<List<ServiceResource>> GetResourceList(bool includeApps, bool includeAltinn2, bool includeExpired, bool includeMigratedResources, CancellationToken cancellationToken = default);
