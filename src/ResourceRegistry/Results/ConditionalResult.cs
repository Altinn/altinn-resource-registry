    ...
    where TTag : notnull
{
    ...
    IActionResult IConvertToActionResult.Convert()
    {
        ...
        var etag = FormatETagValue(Opaque.Create(VersionTag!).ToString());
        ...
        Debug.Assert(resultType == VersionedEntityConditionResult.Succeeded);
        return new VersionedObjectResult(Value, etag, modifiedAt)
        {
            DeclaredType = typeof(TValue),
        };
    }

    private static string FormatETagValue(string value)
    {
