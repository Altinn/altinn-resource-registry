...
namespace Altinn.ResourceRegistry.Controllers
{
    ...
    public class Altinn2ExportController : ControllerBase
    {
        ...
        {
            List<ServiceResource> altinnService = await _resourceRegistry.GetResourceList(includeApps: false, includeAltinn2: true, includeExpired: true, includeMigratedResources:false, cancellationToken);
